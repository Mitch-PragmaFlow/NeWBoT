...
### How do I buy Raider? ###
@newBot.command(name="buy_raider", description="How can I buy $Raider tokens?")
...
### How do I buy Aurum? ###
@newBot.command(name="buy_aurum", description="How can I buy $Aurum tokens?")
...
### How do Stake Raider? ###
@newBot.command(name="stake_raider", description="A quick intro to staking raider")
...
@newBot.command(name="how_do_i_start_playing", description="How do I start playing Crypto Raiders?")
...
###What is questing?
@newBot.command(name="what_is_questing", description="What's Questing? How do I do it?")
...
@newBot.command(name="how_do_stats_work", description="What's Questing? How do I do it?")
...
#Mounts 
@newBot.command(name="how_do_mounts_work", description="What are Mounts and how do they work?")
